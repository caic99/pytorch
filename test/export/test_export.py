...
graph():
    ...
    def test_sym_stack_trace(self):
        ...
        # single line stack trace for sym call _local_scalar_dense
        trace_local_scalar_dense = [
            node for node in ep.graph.nodes
            if node.name in [  # different names for serdes/pre-dispatch
                "_local_scalar_dense",
                "_local_scalar_dense_default",
                "item_default"
            ]
